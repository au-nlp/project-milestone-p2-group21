...
\newcommand{\BLEURTresults}{
  \begin{tikzpicture}
    \begin{axis}[
        ...
        ymin=0,
        xtick=data,
        xticklabels={\tiny{Baseline},\tiny{Token Swap},\tiny{Fine-tuned},\tiny{Token Swap Fine-tuned}},
...
\newcommand{\finetuningloss}{
  \centering
  \includegraphics[width=0.6\textwidth]{data_and_figs/finetuning_training_loss_plot.pdf}
}
...
\newcommand{\tokenreplacementexample}{
  \def\arraystretch{1}%
  \begin{tabular}{ | p {0.3\textwidth} | p {0.3\textwidth} | p {0.3\textwidth} | p {0.15\textwidth} | }
    \hline
    \textbf{\small{Source}}                                                                                     & \textbf{\small{Baseline}}                                                                         & \textbf{\small{Token Replacement}}                                                                     & \textbf{\small{$\Delta$ BLEURT}} \\
    \hline
    \tiny{Rohan was my sibling who always flew a kite at noon, even if it was cloudy.}                          & \tiny{The bridge is opened to the public at noon, and closed at midnight.}                        & \tiny{Rohan is my brother, and he flies kites at noon every day, even when the sky is dark.}           & \small{$\hphantom{-} 0.449$}     \\
    \hline
    \tiny{From 10 feet away you could tell the bottom of the boat was in rough shape.}                          & \tiny{It was very bad from 10 feet away.}                                                         & \tiny{The bottom was in poor condition and visible from a distance of 10 feet;}                        & \small{$\hphantom{-} 0.246$}     \\
    \hline
    \tiny{It includes a legend of a devil beast, a century-old family curse.}                                   & \tiny{It includes a legendary demon beast, a family curse that has lasted for hundreds of years.} & \tiny{He is the one who has been the master of the witchcraft for centuries.}                          & \small{$-0.380$}                 \\
    \hline
    \tiny{Bear in mind, constantly try to purchase silk plants, as they tend to appear like the genuine thing.} & \tiny{Remember, keep trying to buy silk plants because they look like real ones.}                 & \tiny{They are often used to make the plant's leaves and flowers look like they are actually flowers.} & \small{$-0.291$}                 \\
    \hline
  \end{tabular}
}
...
\newcommand{\allscores}{
  ...
  \begin{tabular}{| p {0.18\textwidth} | p {0.18\textwidth} | p {0.18\textwidth} | p {0.18\textwidth} | p {0.18\textwidth} |}
    \hline
    95\% CI         & Baseline           & Token swap         & \textbf{Finetuned} & Finetuned TS       \\
    \hline
    Test set BLEURT & $0.681\pm0.026$ & $0.67\pm0.025$ & $0.725\pm0.020$ & $0.714\pm0.020$ \\
    \hline
  \end{tabular}
}