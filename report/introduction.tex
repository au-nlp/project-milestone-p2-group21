...
We use the unlabeled data to train Cantonese token embeddings and then transform these embeddings into the embedding space of a pre-trained English-Mandarin model, \textsc{MADLAD}\cite{kudugunta2023madlad400multilingualdocumentlevellarge}, using the token-level translations in \textsc{Gatitos}. This \todo{Results of this}.
